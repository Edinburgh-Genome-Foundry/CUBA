...
div
  ...
  .form
    ...
    results-area(:form='form', :backendUrl='infos.backendUrl', :validate_form='validate_form')
</template>

<script>
var infos = {
  title: 'Scenario 1',
  navbarTitle: 'Scenario 1',
  path: 'scenario-one',
  description: 'Design and order your dinosaurs',
  backendUrl: 'start/scenario_one',
  icon: require('assets/images/pencil-icon.svg')
}
